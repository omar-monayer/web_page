    ...
    <main>
        ...
        <h2>Contact us</h2>
            ...
            <div class="container-div">
                <div><i class="fa-solid fa-envelope icon"></i>    Email: wirethefuture@gmail.com</div>
                <div><i class="fa-solid fa-phone icon"></i>    Phone: +962 75981787</div>
                <div><i class="fa-solid fa-location-dot icon"></i>    Location: https://maps.app.goo.gl/uTMtW7YC1vMhkLMw9</div>
            </div>
        </section>
